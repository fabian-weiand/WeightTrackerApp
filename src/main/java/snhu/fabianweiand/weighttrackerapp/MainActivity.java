...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eTargetButton = findViewById(R.id.buttonTarget);
        cWeightButton = findViewById(R.id.buttonCurrent);
        tHistory = findViewById(R.id.textHistory);
        cWeight = findViewById(R.id.weightDis1);
        tWeight = findViewById(R.id.weightDis2);
        mScrollText = findViewById(R.id.mainScrollText);
        tSignOut = findViewById(R.id.signOut);
